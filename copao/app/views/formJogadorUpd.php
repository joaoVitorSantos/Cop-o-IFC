      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card text-white p-5 bg-primary">
            <div class="card-body">
              <h1 class="mb-4">Atualizar um jogador</h1>
              <form  method="post" action="JogadorController.php?acao=editarjogconf&id=<?= $id ?>">
                <div class="form-group">
                  <label>Id do jogador</label>
                  <input type="number" class="form-control" name="id_jogador" placeholder="Id of the player" value="<?= $id?>"> </div>
                <div class="form-group">
                  <label>Número da Camisa</label>
                  <input type="number" class="form-control" name="numero_camisa" placeholder="The number of shirt" value="<?= $jogador->getNumeroCamisa()?>"> </div>
                <div class="form-group">
                  <label>Nome</label>
                  <input type="text" class="form-control" name="nome" placeholder="The name" value="<?= $jogador->getNome()?>"> </div>
                <div class="form-group">
                  <label>Gols</label>
                  <input type="number" class="form-control" name="gols" placeholder="Number of gols" value="<?= $jogador->getGols()?>"> </div>
                <div class="form-group">
                  <label>Cartões Amarelos</label>
                  <input type="number" class="form-control" name="cartao_amarelo" placeholder="Number of yellow cards" value="<?= $jogador->getCartaoAmarelo()?>"> </div>
                <div class="form-group">
