...
<div class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form class="" action="../controller/AtualizadorController.php?rota=paridas">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Time 1</label>
                        <select class="custom-control custom-select" draggable="true">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inlineFormInput" placeholder="Dia de Mes de Ano"> </div>
                    <div class="form-group">
